...
import { getPokemons, getFavorites, getPokemonByName, resetStore } from '../actions/index';
	...
	return (
		<React.Fragment>
			...
			<Grid className={classes.buttonFavorites}>
				<Button onClick={() => history.push('/favorites')} variant="contained" color="secondary">
					favorites
				</Button>
			</Grid>
			<Switch>
